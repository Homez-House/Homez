        ...
        <div class="col">
          ...
          <div class="row mb-4 form-group">
            ...
            <input
              ...
              readonly
              v-model="$store.state.login.memberId"
            />
          </div>
          <div class="row mb-4 form-group">
          ...
          <div class="row mb-4 form-group">
            ...
            <input
              type="text"
              class="form-control col"
              v-model="$store.state.login.memberName"
            />
          </div>
          <div class="row mb-4 form-group">
            ...
            >
              <input
                ...
                type="radio"
                :value="code.code"
                v-model="$store.state.login.memberGender"
              />
          ...
          <div class="row mb-4 form-group">
            ...
            >
              <input
                ...
                type="radio"
                :value="code.code"
                v-model="$store.state.login.memberAge"
              />
              <label class="form-check-label">{{ code.codeName }}</label>
            </div>
          </div>
          <div class="row mb-4 form-group">
            ...
            <input
              type="text"
              class="form-control col"
              v-model="$store.state.login.memberEmail"
            />
          </div>
          <div class="row mb-4 form-group">
            <label class="mb-2"
